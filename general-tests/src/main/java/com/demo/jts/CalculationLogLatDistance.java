...
public class CalculationLogLatDistance {
    ...
    public static void main(String[] args) {
        ...
        System.err.println(GetDistanceOne(lon1, lat1, lon2, lat2));
        System.err.println(GetDistanceTwo(lon1, lat1, lon2, lat2));
        System.err.println(GetDistanceThree(lon1, lat1, lon2, lat2));

        System.err.println(RoadNetUtils.calDis(lon1, lat1, lon2, lat2));
        System.err.println(RoadNetUtils.calSpherDistance(lon1, lat1, lon2, lat2));
