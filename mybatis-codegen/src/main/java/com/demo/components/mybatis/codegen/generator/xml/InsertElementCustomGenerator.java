...
public class InsertElementCustomGenerator extends InsertElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        } else if (introspectedTable.getPrimaryKeyColumns().size() == 1 && introspectedTable.getPrimaryKeyColumns().get(0).isGeneratedAlways()) {
        ...
        boolean hasColumnDefaultValue = ListUtilities.removeIdentityAndGeneratedAlwaysColumns(this.introspectedTable.getAllColumns())
                .stream().anyMatch(column -> column.getDefaultValue() != null);
        if (!hasColumnDefaultValue) {
    ...
    public void addElementsWithDefaultColumns(XmlElement xmlElement, XmlElement answer) {
        ...
        for (int i = 0; i < columns.size(); i++) {
            ...
            if (column.getDefaultValue() == null) {
                trimElement.addElement(new TextElement(columnName + ","));
            } else {
