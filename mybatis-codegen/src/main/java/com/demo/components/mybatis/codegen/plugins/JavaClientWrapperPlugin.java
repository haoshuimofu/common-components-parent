...
import com.demo.components.mybatis.codegen.generator.CustomCommentGenerator;
 ...
 */
public class JavaClientWrapperPlugin extends PluginAdapter {

    private Logger logger = LoggerFactory.getLogger(JavaClientWrapperPlugin.class);
    ...
    public boolean modelPrimaryKeyClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        // logger.info(">>> [{}]: 文件已存在!!!", modelKeyJavaFile.getPath());
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        if (commentGenerator != null) {
            ((CustomCommentGenerator) commentGenerator).addMapperInterfaceComment(interfaze, introspectedTable);
        }
