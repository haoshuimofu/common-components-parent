...
import com.demo.components.rabbitmq.test.message.TopicMessageABody;
 ...
 */
@ConsumerService
public class TopicMessageAConsumerService extends AbstractConsumerService<TopicMessageABody> {
