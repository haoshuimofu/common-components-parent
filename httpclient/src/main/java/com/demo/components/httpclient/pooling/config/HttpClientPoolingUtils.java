...
public class HttpClientPoolingUtils {
    ...
    public HttpClientPoolingUtils(PoolingHttpClientConnectionManager connectionManager, HttpClientPoolingProperties properties) {
    ...
    public static String get(String url, Map<String, String> headers, int connectTimeout, int socketTimeout) throws Exception {
        ...
        return HttpClientPoolingUtils.executeHttpRequest(httpClient, httpGet);
    }
    ...
    public static String postForm(String url, Map<String, String> headers, Map<String, String> params,
        ...
        return HttpClientPoolingUtils.executeHttpRequest(httpclient, httpPost);
    }
