 ...
 */
@ESDocument(index = "station_product", schema = "es-schema/station_product.json", join = @JoinField(type = JoinFieldTypeEnum.NONE))
public class StationProduct extends BaseIndexModel {
    @ESID
    @ESTransient
    private String id;
    private String name;
    ...
    public StationProduct(String stationId, String productId) {
